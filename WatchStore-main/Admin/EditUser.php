...
<!--                                    <th style="text-align: center;" class="sorting" tabindex="0"  rowspan="1" colspan="1">Nhập lại Mật khẩu</th>-->
                                    <th style="text-align: center;" class="sorting" tabindex="0"  rowspan="1" colspan="1">Role</th>
...
<!--                                        </td>-->
                                        <td>
                                            <input type="text" name="fullname" placeholder="Full name" value="Admiin" class="form-control">
                                        </td>
                                        <td>
